 ...
 * Return:Returns error -1, 0 at success
 */
...
/**
 * set_alias -  This either sets an existing alias 'name' with a new value
...
/**
 * replace_aliases -This finds arguments and replace any matching alias
 * @args: The 2D pointer to the arguments
 * Return:Returns 2D pointer to the arguments
 */
