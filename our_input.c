...
/**
 * free_args -This frees up memory taken by args.
...
/**
 * get_pid - The function to gets the current process ID.
...
/**
 * get_env_value -The function to gets the value corresponding to variable
...
/**
 * variable_replacement - The function that handles variable replacement.
 * @line:The  double pointer containing the command and arguments.
 * @exe_ret:The  pointer return value of the last executed command
 */
